    ...
    <div class="idTabs">
          ...
          <div class="am-u-sm-12 am-u-md-9">
                <form class="am-form am-form-horizontal banner-upload"  enctype="multipart/form-data" action='/admin/config' method='post'>
                    ...
                    <div class="am-form-group">
                        <label class="am-u-sm-3 am-form-label">网站logo</label>
                        <div class="am-u-sm-9">
                            <div class="img-wrap" style="width:200px;overflow:hidden;position:relative">
                                <img src="{{$res['logo']}}" onerror="javascript:this.src='/admins/img/upload_icon.jpg'" id="myimg" class="am-img-thumbnail">
                                <input type="file" value="" name="logo" id="pic" style="position:  absolute;top: 0;width:  100px;height:  83px;opacity:  0;" >
